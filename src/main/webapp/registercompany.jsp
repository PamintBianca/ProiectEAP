...
<form align="center" method="post" action="/registercompany" class="form">
...
<p align="center">
    <%
        if (request.getAttribute("loginError") != null)
            ...
            String form = "<h1>Contul tau a fost creat cu succes! Te poti <a href='/logincompany'>conecta</a>!</h1>";
