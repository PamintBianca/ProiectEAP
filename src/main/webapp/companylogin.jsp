...
<form align="center" method="post" action="/logincompany" class="form">
...
<p align="center">
    <%
        if (request.getAttribute("loginError") != null)
            ...
            out.print("Salut " + request.getAttribute("nume"));

            out.print("<br>");
            out.print("<br>");
            String form = "<h1>Vezi <a href='/companybikes'>biciclete</a>!</h1>";
